...
const SassonBar = () => {
    ...
    useEffect(() => {
        const fetchBarInfoAndSetupGame = async () => {
            try {
                console.log('Fetching bar information for SassonBar...');
                const response = await axios.get('https://getloose-server.onrender.com/api/bar/SassonBar');
