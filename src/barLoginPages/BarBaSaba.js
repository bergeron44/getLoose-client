...
const BarBaSaba = () => {
    ...
    useEffect(() => {
        const fetchBarInfoAndSetupGame = async () => {
            try {
                console.log('Fetching bar information for BarBaSaba...');
                const response = await axios.get('https://getloose-server.onrender.com/api/bar/BarBaSaba');
