...
const ChooseFriends = () => {
    ...
    const tableName = useSelector(state => state.liveGame?.currentTableName); // Safe access
    const tableNumber = useSelector(state => state.liveGame?.currentTableNumber); // Safe access
